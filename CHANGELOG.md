...
- Add `set_secret=provider,secret` option to Authenticator plugin
- Add support for extracting Authenticator keys via the `otpauth://` protocol

### Fixed

- Fix context window error by stopping LLM inference if input context window is larger than the default setting

## [0.1.7] - 11/09/2026

### Fixed

- Fix major bug when piping data to AI patterns
